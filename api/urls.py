...
urlpatterns = [
    ...
    path('booking-change-is-take/<str:key>/<int:is_take>/', views.booking_change_is_take, name='booking_change_is_take'),
    path('get_rooms_status/<str:floor>/', views.get_rooms_status, name='get_rooms_status')
]
