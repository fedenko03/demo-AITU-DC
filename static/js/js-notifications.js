...
function createNotification(data) {
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-body px-4 py-5 px-md-5" style="margin-top: -20px;padding-bottom: 55px;margin-bottom: -35px;width: 400px;">
            ...
            <h5 class="fs-4 fw-bold text-primary card-title"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-exclamation-circle fs-2 text-primary" style="padding-bottom: 0px;margin-bottom: 3px;">
